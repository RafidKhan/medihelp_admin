...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/icon_history.png
  AssetGenImage get iconHistory =>
      const AssetGenImage('assets/icons/icon_history.png');
  ...
  List<AssetGenImage> get values =>
      [iconCart, iconHistory, iconHome, iconSearch, iconSetting, user];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/transparent_bg.png
  AssetGenImage get transparentBg =>
      const AssetGenImage('assets/images/transparent_bg.png');

  /// List of all assets
  List<AssetGenImage> get values => [transparentBg];
}
